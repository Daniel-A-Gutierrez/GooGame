...
public class LaunchArcMesh : MonoBehaviour {
    ...
    void CalculateAngle() {
        //returns angle in degrees given a vector from the player to the object...

        Vector3 aim_vector = player_vector - Camera.main.transform.position; 
        ...
        Vector3 look_vector;
        look_vector.x = x - center_x;
        look_vector.y = y - center_y;
        look_vector.z = x - center_x;

        angle = Vector3.Angle(aim_vector, look_vector);
    }
